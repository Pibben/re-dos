...
#if 0
static uint16_t _random = 0x9234;
#define RAND_MAX 0xffff

// TODO: a better than quick'm dirty random!
long int random()
{
  float f = sin(_random); // -1..1
  _random = f * RAND_MAX;
  return _random;
}
#elif 1
...
static uint64_t s[2] = { 0xdf900294d8f554a5, 0x170865df4b3201fc };
